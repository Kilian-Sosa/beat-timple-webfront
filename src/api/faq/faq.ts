export const faqs =[
    {
       "id":0,
       "question": "¿Qué es VR Dream Escape?",
       "answer": "VR Dream Escape es un juego de Realidad Virtual en el que se pretende retar al jugador con distintos desafíos en un mundo más parecido a un sueño que a la realidad. El objetivo final del juego es poder salir de ese sueño, pero para ello tendrá que supera cada una de las tres pruebas"
    },
    {
       "id":1,
